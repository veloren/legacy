...
pub use region::{Block, Chunk, ChunkConverter, FnPayloadFunc, Volume, Voxel};
...
pub struct Client<P: Payloads> {
    ...
    chunk_mgr: VolMgr<Chunk, ChunkConverter<Block>, <P as Payloads>::Chunk>,
...
impl<P: Payloads> Client<P> {
    ...
    pub fn chunk_mgr(&self) -> &VolMgr<Chunk, ChunkConverter<Block>, P::Chunk> { &self.chunk_mgr }
